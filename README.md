...
Je comprends votre réticence concernant les environnements virtuels (`venv`). Bien qu'ils soient la norme pour le développement Python, ils ajoutent effectivement une étape d'activation pour l'utilisateur. 
